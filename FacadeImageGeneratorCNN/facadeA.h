...
cv::Mat generateRandomFacadeA(int width, int height, int thickness, const std::pair<int, int>& range_NF, const std::pair<int, int>& range_NC, std::vector<float>& params, int window_displacement = 0, float window_prob = 1);
